...
// e.g., https://yourdomain.com/api/paytm_callback.php
define('PAYTM_CALLBACK_URL', getenv('PAYTM_CALLBACK_URL') ?: ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']==='on'?'https':'http').'://'.$_SERVER['HTTP_HOST'].str_replace('dashboard.html','', $_SERVER['REQUEST_URI']).'api/paytm_callback.php'));
